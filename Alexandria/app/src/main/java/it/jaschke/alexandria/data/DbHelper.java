...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_BOOK_TABLE = "CREATE TABLE " +
                ...
                AlexandriaContract.BookEntry.IMAGE_URL + " TEXT, " + "UNIQUE (" +
                AlexandriaContract.BookEntry._ID + ") ON CONFLICT IGNORE)";
        ...
        final String SQL_CREATE_AUTHOR_TABLE = "CREATE TABLE " +
                ...
                AlexandriaContract.AuthorEntry.AUTHOR + " TEXT," + " FOREIGN KEY (" +
                AlexandriaContract.AuthorEntry._ID + ") REFERENCES " +
                AlexandriaContract.BookEntry.TABLE_NAME + " (" +
        ...
        final String SQL_CREATE_CATEGORY_TABLE = "CREATE TABLE " +
                ...
                AlexandriaContract.CategoryEntry.CATEGORY + " TEXT," + " FOREIGN KEY (" +
