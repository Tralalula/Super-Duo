// Barcode Scanner by Arjun U.
// http://arjunu.com/2015/08/android-barcode-detection-tracking-using-mobile-vision-api/
...
public class BarcodeScannerActivity extends AppCompatActivity implements BarcodeTrackerFactory.BarcodeCallbacks {
    ...
    public void onBarcodeFound(Barcode barcode) {
        ...
        resultIntent.putExtra(AddBook.BARCODE_SCANNER_PARCELABLE_TEXT, barcode);
